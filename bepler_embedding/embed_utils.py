...
def remake_pretrained_model(model : nn.Module) -> nn.Module: 
    ...
    Args: 
        model : Should be a SCOPCM model as uploaded and saved 
    Return: 
        nn.Module
    ...
    embedding_module.load_state_dict(model.embedding.state_dict())
